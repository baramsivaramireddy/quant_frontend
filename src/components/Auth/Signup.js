      ...
      <form className="flex flex-col gap-5" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div>
          <input
            ...
            type="email"
            className="outline-1 outline-gray-200 rounded p-2 outline-none hover:outline lo hover:outline-black hover:outline-1 focus:outline focus:outline-1 focus:outline-blue-500"
        ...
        <div className=" bg-blue-500 text-white py-3 px-2 rounded-full text-center font-semibold hover:bg-blue-700">
          <button disabled={IsSendingData} type="submit">
            {" "}
            {IsSendingData ? "Creating an account..." : "Sign UP"}{" "}
          </button>
        </div>
      </form>
    </div>
